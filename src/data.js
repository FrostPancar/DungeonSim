...
export const BUILDINGS = {
  ...
  // The pen is dragged out as a rectangle: 'pen' is its fence, one per edge tile,
  // priced like a timber wall; the gate comes with it and is never placed alone.
  pen:       { name: 'Animal Pen',      cat: 'farm',      cost: { wood: 4 },               work: 20,  solid: true,  hp: 90, glyph: '|', beauty: 0.5, desc: 'Drag out a rectangle: a fence goes round its edge with a gate on the side facing camp. Tame stock lives inside. Each fence post costs as much as a timber wall.' },
  pen_gate:  { name: 'Pen Gate',        cat: 'farm',      cost: { wood: 4 },               work: 20,  solid: false, hp: 90, glyph: '=', hidden: true, desc: 'The way into a pen. People and beasts on a lead pass; loose stock stays inside.' },
...
export const RESEARCH = {
  ...
  ranching:   { name: 'Ranching',         cost: 240,  req: ['husbandry'],  unlock: ['pasture','pen','pen_gate','trough','butchery','stable'], bonus: { husbandry: 0.15 }, desc: 'Tame and keep livestock.' },
